        ...
        {step === 1 && (
          <div className="p-6">
            ...
            <div className="mb-6">
              ...
              <div className="flex">
                <div className="bg-gray-100 border-2 border-r-0 border-orange-200 rounded-l-xl px-4 py-3 flex items-center">
                  <img src={selectedCountry.flag} alt={selectedCountry.label} className="w-6 h-4 object-cover rounded-sm border border-gray-200 mr-2" />
                ...
                <input
                  ...
                  className={`flex-1 border-2 border-l-0 rounded-r-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 ${
